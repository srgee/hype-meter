...
class TestHypeEngineIntegration:
    ...
    def test_engine_handles_provider_failure(self, mocker, engine):
        mocker.patch(
            'apps.providers.google.GoogleTrendsProvider.fetch_score', 
    ...
    def test_google_provider_error_handling(self, mocker, engine):
        ...
        mocker.patch('apps.providers.bluesky.BlueskyProvider.fetch_score', return_value=50)
    ...
    def test_engine_weighted_calculation(self, mocker, engine):
        ...
        mocker.patch('apps.providers.bluesky.BlueskyProvider.fetch_history', return_value={})
